...
if __name__ == '__main__':
    ...
    # dataset.add_mandatory_input('t1', 'raw')
    ...
    ###
    #for prefix in ['sr', 'srblur']:
    for prefix in ['img']:
        if site in ['site00', 'site13', 'site18']:
            #modifiers = '_' + prefix + '_prep_pad'
            modifiers = '_prep_pad'
            first_step = pb.PyPadCommand(
                        "Pad flair by convention",
                        #cmdName=os.path.join(cwd, 'strip_header.py'),
                        input=dataset.get_original(subj=subj, modality='flair', feature=prefix),
        ...
        #stroke_atlas_files['pca_sdm_{}'.format(pca)] = '_pcasdmv6_{}'.format(pca)
            ...
            for mask_feature in ['_fixed_mask_from_seg_binary']:
                ...
                for pca_component in range(1,44):
                    component = buckner.get_original(feature='_pcav6_{}'.format(pca_component))
